...
function herd_coop_5_basic(;
  ...
  cost = let
    ...
    function stage_cost(x, u, t, context_state)
      ...
      cp1 = distance_function(xp1 - evm)
      # sum of distance from evm of all evaders
      cp1 += distance_function(xe1_evm) /5
      cp1 += distance_function(xe2_evm) /5
      cp1 += distance_function(xe3_evm) /5
      cp1 += distance_function(xe4_evm) /5
      cp1 += distance_function(xe5_evm) /5

      cp2 = distance_function(xp2 - evm)
      # sum of distance from evm of all evaders
      cp2 += distance_function(xe1_evm) /5
      cp2 += distance_function(xe2_evm) /5
      cp2 += distance_function(xe3_evm) /5
      cp2 += distance_function(xe4_evm) /5
      cp2 += distance_function(xe5_evm) /5
