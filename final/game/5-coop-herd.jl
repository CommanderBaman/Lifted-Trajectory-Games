...
function herd_coop_5_basic(;
  ...
  player_bounds=[[5, 10], [5, 10], [1, 2], [1, 2], [1, 2], [1, 2], [1, 2]],
  ...
  cost = let
    ...
    function stage_cost(x, u, t, context_state)
      ...
      xp1, xp2, xe1, xe2, xe3, xe4, xe5 = blocks(x)
      ...
      cp1 += herd_distribution_weight * distance_function(xe1_evm) /5
      cp1 += herd_distribution_weight * distance_function(xe2_evm) /5
      cp1 += herd_distribution_weight * distance_function(xe3_evm) /5
      cp1 += herd_distribution_weight * distance_function(xe4_evm) /5
      cp1 += herd_distribution_weight * distance_function(xe5_evm) /5

      cp2 = herd_center_weight * distance_function(xp2 - evm)
      # sum of distance from evm of all evaders
      cp2 += herd_distribution_weight * distance_function(xe1_evm) /5
      cp2 += herd_distribution_weight * distance_function(xe2_evm) /5
      cp2 += herd_distribution_weight * distance_function(xe3_evm) /5
      cp2 += herd_distribution_weight * distance_function(xe4_evm) /5
      cp2 += herd_distribution_weight * distance_function(xe5_evm) /5
      ...
      ce4 = distance_function(xe4_xp1) + distance_function(xe4_xp2)
      ce5 = distance_function(xe5_xp1) + distance_function(xe5_xp2)

      [cp1, cp2, -ce1, -ce2, -ce3, -ce4, -ce5]
    end
...
function herd_coop_5_adv1(;
  ...
  cost = let
    ...
    function stage_cost(x, u, t, context_state)
      ...
      ce4 -= herd_bonus * distance_function(xe4_evm)
      ce5 -= herd_bonus * distance_function(xe5_evm)
