...
function herd5_basic(;
  ...
  cost = let
    ...
    function stage_cost(x, u, t, context_state)
      ...
      cp += herd_distribution_weight * distance_function(xe1_evm) /4
      cp += herd_distribution_weight * distance_function(xe2_evm) /4
      cp += herd_distribution_weight * distance_function(xe3_evm) /4
      cp += herd_distribution_weight * distance_function(xe4_evm) /4
