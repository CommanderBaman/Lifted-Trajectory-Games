...
# global variables
game_type = "5-herd"
player_dynamics = [FAST_PLAYER, CHOSEN_PLAYER, CHOSEN_PLAYER, CHOSEN_PLAYER, CHOSEN_PLAYER]
initial_state_config = "random" # "random" or "static"
strategies = ["lifted", "lifted", "lifted", "lifted", "lifted"]
animation_labels = ["pursuer", "evader", "evader", "evader", "evader"]
animation_colors = [colorant"red", colorant"blue", colorant"blue", colorant"blue", colorant"blue"]
